...
gen_model_img(encoder, 'autoencoder_encoder.png')
gen_model_img(decoder, 'autoencoder_decoder.png')
gen_model_img(autoencoder, 'autoencoder.png')
...
plt_metrics(hist, get_full_file_name('autoencoder_metrics.png'))

encoded_imgs = encoder.predict(x_test)
decoded_imgs = decoder.predict(encoded_imgs)

plot_op(x_test, decoded_imgs, get_full_file_name('autoencoder_op.png'))